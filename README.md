...
A pre-built vLLM container compiled for NVIDIA DGX Spark (GB10, SM 12.1) is available:
...
```bash
vllm serve /path/to/Gemma-4-31B-it-DECKARD-HERETIC-Uncensored-NVFP4 \
  --served-model-name deckard \
  --quantization modelopt \
  --dtype auto \
  --kv-cache-dtype fp8 \
...
|---|---|---|---|---|
| **Gemma 4 31B DECKARD AWQ_FULL** | Dense NVFP4 | 20.5 GB | ~12-14 | [HuggingFace](https://huggingface.co/AEON-7/Gemma-4-31B-it-DECKARD-HERETIC-Uncensored-NVFP4) |
...
|---|---|---|
| **vLLM Container** | Pre-built for DGX Spark SM 12.1 | [GHCR](https://github.com/users/AEON-7/packages/container/package/vllm-spark-gemma4-nvfp4) |
